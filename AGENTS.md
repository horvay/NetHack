...
- Preserve real NetHack behavior and classic/manual keyboard flows unless the Boss explicitly asks to change them.
- Document evidence paths, commands run, screenshot inspection notes, caveats, and remaining risks in `employee-result.md`.
