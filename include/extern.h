...
extern void equipment_change_canned_queue_cleared(void);
extern void equipment_change_before_native_delay(void);
extern void equipment_change_after_native_delay(void);
