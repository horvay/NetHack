...
function reviewRun(outputDir, reviewFile) {
  ...
  console.log(`real-scenario-iron-skull-cap-tooltip-mcp-test: APPROVED ${approval.runIdentity} ${manifestFile}`);
}
...
async function main() {
  ...
  console.log(`real-scenario-iron-skull-cap-tooltip-mcp-test: CAPTURED ${page.outputIdentity} ${qc.manifestFile}`);
